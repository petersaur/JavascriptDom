...
var tbody, filterBtn, inputField, submit, inputDate, inputValue, filterdata;
...
submit.on("click", function() {
  ...
  if (inputValue) {
  filterdata = tableData.filter(onerec => onerec.datetime === inputValue);}
